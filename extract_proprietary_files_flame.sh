...
echo -e "\t\e[32mFixing file product/etc/permissions/telephonyservice.xml\e[0m"
sed -i 's/\/system\/product/\/product/' $PWD/flame/proprietary/product/etc/permissions/telephonyservice.xml
