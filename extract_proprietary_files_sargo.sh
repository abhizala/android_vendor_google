...
do
    source_location=/media/ssd/dump/system/system
...
do
    source_location=/media/ssd/dump/system_ext
...
do
    source_location=/media/ssd/dump/product
...
do
    source_location=/media/ssd/dump/vendor
